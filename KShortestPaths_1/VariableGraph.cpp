...
const double VariableGraph::DISCONNECT = (numeric_limits<double>::max)();


VariableGraph::VariableGraph( const string& file_name )
{
	_import_from_file(file_name);
}

VariableGraph::VariableGraph( const VariableGraph& graph )
{
...
VariableGraph::~VariableGraph(void)
{
	clear();
}
...
///////////////////////////////////////////////////////////////////////////////
void VariableGraph::_import_from_file( const string& input_file_name )
{
...
BaseVertex* VariableGraph::get_vertex( int node_id )
{
...
int VariableGraph::get_edge_code( const BaseVertex* start_vertex_pt, const BaseVertex* end_vertex_pt ) const
{
...
BaseVertex* VariableGraph::get_vertex_by_ID( int id ) const
{
	return m_vtVertices.at(id);
}

set<BaseVertex*>* VariableGraph::get_vertex_set_pt( BaseVertex* vertex_, map<BaseVertex*, set<BaseVertex*>*>& vertex_container_index )
{
...
void VariableGraph::get_vertex_list( vector<BaseVertex*>& vertex_list )
{
...
double VariableGraph::get_edge_weight( const BaseVertex* source, const BaseVertex* sink )
{
...
void VariableGraph::get_adjacent_vertices( BaseVertex* vertex, set<BaseVertex*>& vertex_set )
{
...
void VariableGraph::get_precedent_vertices( BaseVertex* vertex, set<BaseVertex*>& vertex_set )
{
